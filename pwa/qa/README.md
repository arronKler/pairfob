...
- Acceptance evidence is recorded in `docs/refactoring/pwa-react-progress.md`; keep source/test, rendered fixture, live transport and physical-device results distinct.
