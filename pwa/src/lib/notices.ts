...
export const FRIENDLY_ERROR: Record<string, string> = {
  ...
  pair_busy: "电脑正在处理另一次配对。请等当前这次结束，或重新运行 pairfobd pair。",
  invalid_pair_ref: "这个配对二维码已经失效。请使用电脑当前打印的码。",

  daemon_offline: "电脑现在不在线。若刚合盖，电脑可能已经睡眠。醒来或打开 pairfobd 后会自动重连，不用重新配对。也可运行 pairfobd doctor。",
  ws_open_failed: "暂时连不上 Pairfob。请检查网络后重试。",
  revoked: "这台手机已被解除配对。请在电脑上重新运行 pairfobd pair。",
  herdr_offline: "电脑上的 Herdr 现在没开。打开后会自动恢复。",
  kicked: "另一个窗口接管了这台手机。请只保留一个打开的 Pairfob 页。",
  too_many_devices: "已配对设备太多。在电脑上用 pairfobd list / forget 腾出位置后再试。",
  unbound: "还没有连上电脑。请刷新，仍不行就重新配对。",
  wrong_ws: "连接类型不对。请刷新页面。",
  enroll_required: "这台电脑还没有完成安装。请在电脑上重新运行安装脚本。",
  index_unavailable: "暂时找不到这台电脑。请稍后刷新，或在电脑上运行 pairfobd doctor。",
  ...
  unknown_op: "当前版本不支持这个操作。请刷新页面，或在电脑上运行 pairfobd doctor。",
