...
import { app, leavePaneScreen, replaceAgentsFromSnapshot, state } from "../../state";
import { NO_OPERATION_CAPABILITIES } from "../../lib/operations";
import { releaseBoardScroll } from "../board-canvas";
import { clearBoardPreviews } from "../board-preview";
import { BoardScreen } from "./board";
import { click, installBoardPainter, paintBoard, unmountReact } from "../../../test-support/react-harness";
...
describe("react board screen", () => {
  ...
  test("leaving the board unmounts without keeping the screen on board", () => {
    boot();
    state.screen = "home";
    unmountReact();
    expect(app.querySelector(".board-shell")).toBeNull();
  });
});
