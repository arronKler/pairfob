(function () {
  ...
  const zh = {
    ...
    "start.eyebrow": "怎么用",
    "start.h2": "三步就能用上。",
    "start.lede": "电脑上装一个常驻的 pairfobd，手机扫一次码完成配对。之后在手机打开 Pairfob，就是电脑上那一群会话。",
    "start.prereq.b": "先决条件",
    "start.prereq1": "Pairfob 不自带 Agent，它是",
    "start.prereq2": " 的手机端。电脑上要先装好 Herdr 0.7 以上；pairfobd 启动时会无感拉起它。装完后",
  ...
  const en = {
    ...
    "start.lede": "Install a resident pairfobd on the computer, scan once to pair. After that, Pairfob on the phone is the herd on that computer.",
    "start.prereq.b": "Prerequisite",
    "start.prereq1": "Pairfob does not ship an agent. It is the phone surface for",
    "start.prereq2": ". Install Herdr 0.7 or newer; pairfobd quietly starts it on launch. After installation,",
    ...
    "path.d3": "pairfobd dials out. No inbound ports on the machine",
    "faq.eyebrow": "FAQ",
    "faq.h2": "A few things people get stuck on.",
    "faq.lede": "Accounts, a closed lid, Windows, several computers, and inbound ports.",
    ...
    "faq.q3": "Can I install pairfobd on Windows?",
    ...
    "faq.a4": "No. pairfobd only dials out.",
